...
public class CombatBuilder {
	...
	public void attack(Character target) {
		...
		if(victim instanceof MiniPlayer) {
			MiniPlayer mini = (MiniPlayer) victim;
			setVictim(mini.getMiniPlayerOwner());
			target = mini.getMiniPlayerOwner();
		}
	...
	public Character getVictim() {
		if(victim instanceof MiniPlayer)
			return ((MiniPlayer) victim).getMiniPlayerOwner();
		return victim;
	}
