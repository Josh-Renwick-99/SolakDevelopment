...
public class ZoneData {
    ...
    public enum Monsters {
        ...
        SQUIRTLE(9004, 75, new Item[]{new Item(995, 69), new Item(995, 69), new Item(995, 69)}),
        MEWTWO(9005, 100, new Item[]{new Item(995, 69), new Item(995, 69), new Item(995, 69)}),
        BOWSER(9006, 150, new Item[]{new Item(995, 69), new Item(995, 69), new Item(995, 69)}),
        ;
