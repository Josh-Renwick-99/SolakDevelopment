...
public class ZoneData {
    ...
    public enum Monsters {
        ...
        PATRICK(9002, 25, new Item[]{new Item(703), new Item(704), new Item(705)}),
        LUIGI(9003, 50, new Item[]{new Item(14924), new Item(14919), new Item(14915)}),
        SQUIRTLE(9004, 100, new Item[]{new Item(ItemDefinition.TOKEN_ID, 1000),  new Item(2734, 1),  new Item(19114, 5)}),
        MEWTWO(9005, 150, new Item[]{new Item(23044),  new Item(ItemDefinition.TOKEN_ID, 5000),  new Item(2734, 5)}),
        //BOWSER(9006, 225, new Item[]{new Item(ItemDefinition.COIN_ID, 10000000)})
        ;
